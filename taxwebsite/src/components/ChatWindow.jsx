...
const ChatWindow = ({ isOpen, onClose }) => {
  ...
  const [messages, setMessages] = useState([questions[questionIndex]]);
  ...
  const handleUserMessageSubmit = () => {
    ...
    const newMessages = [...messages, userMessage]; // Add user message 
    ...
    if (questionIndex < questions.length - 1) {
      ...
      setMessages(prevMessages => [...prevMessages, questions[questionIndex + 1]]); // Update messages array
    }
  };
